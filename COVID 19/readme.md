...
**NOTA ACLARATORIA DE DATADISTA (21/05/2020)**: Sanidad ha dejado de publicar en sus informes diarios los datos de recuperados y testAC desde 18/05/2020. El ISCIII lleva desde el 18/05/2020 sin actualizar la serie histórica. Por este motivo, no podemos actualizar los datasets ccaa_covid19_casos.csv, ccaa_covid19_confirmados_test.csv y ccaa_covid19_altas.csv y sus versiones larga.
