...
**NOTA ACLARATORIA DE DATADISTA (21/05/2020)**: Sanidad ha dejado de publicar en sus informes diarios los datos de recuperados y testAC y casos confirmados por rango de edad desde 18/05/2020. El ISCIII lleva desde el 18/05/2020 sin actualizar la serie histórica. Por este motivo, no podemos actualizar los datasets nacional_covid19_rango_edad.csv, ccaa_covid19_casos.csv, ccaa_covid19_confirmados_test.csv y ccaa_covid19_altas.csv y sus versiones larga.
